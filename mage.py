...
def getfullname_S99_spectrum(rootname) : # Check whether a S99 spectrum exists
    S99file = get_S99_path() + rootname + '-sb99-fit.txt'
...
def redo_open_S99_spectrum(rootname, denorm=True, altfile=None) : 
    ...
    else :        S99file =  getfullname_S99_spectrum(rootname)
...
def open_stacked_spectrum(mage_mode, alt_infile=False, which_stack="standard", colfnu='fweightavg', colfnuu='fjack_std', addS99=False) :
    ...
    if addS99 and which_stack == "Stack-A" and getfullname_S99_spectrum(which_stack) :
        (S99, ignore_linelist) = redo_open_S99_spectrum(which_stack, denorm=True)
